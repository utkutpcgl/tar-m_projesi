#!/usr/bin/env python3
"""Generate the V11 R2 gate-repair pilot with stratified profiles."""
...
PROFILED_GENERATOR = (
    Path(__file__).resolve().parent / "generate_cropcraft_profiled_pilot_v2.py"
)
...
def main() -> None:
    ...
    receipt["profiled_role_generator_sha256"] = legacy.sha256(
        PROFILED_GENERATOR
    )

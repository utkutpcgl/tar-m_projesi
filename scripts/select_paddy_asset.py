#!/usr/bin/env python3
"""Apply the frozen paddy synthetic-asset screen/confirmation protocol."""
...
def main() -> None:
    ...
    if args.stage == "screen":
        ...
        if winner not in protocol["screen_candidates"]:
            raise ValueError("Screen receipt selected an undeclared challenger")
    ...
    for name in sorted(expected_names):
        ...
        receipt_path = candidate_dir / (
            f"paddy_development_fixed_epoch{protocol['fixed_epoch']}_"
    ...
    if args.stage == "screen":
        ...
        for candidate in candidate_names:
            ...
            checks = {
                ...
                "rice_gain": delta["rice_mean_iou"]
                >= float(rules["rice_mean_iou_delta_must_be_at_least"]),
        ...
        for candidate in candidate_names:
            ...
            checks = {
                ...
                "mean_rice_gain": means["rice_mean_iou"]
                >= float(rules["mean_rice_delta_must_be_at_least"]),
                **{
